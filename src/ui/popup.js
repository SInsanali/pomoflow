...
// Today's pomodoros against the session goal. Deliberately *today's* count, not
// cycle.totalPomodoros — the header's 0/4 is all-time, which is a fine thing to
// see next to a running timer and a useless thing to call a goal ring.
